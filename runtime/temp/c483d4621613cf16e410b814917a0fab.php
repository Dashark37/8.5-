<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\jiuyeban\xuchaoyu\tpshop\public/../application/home\view\goods\detail.html";i:1533832600;}*/ ?>
								...
								<dl>
									...
									<dd>
										...
										<a <?php echo $k==0?'class="selected"':''; ?> href="javascript:;">
											<?php echo $attr['attr_value'].'价格-&yen;'.$attr['attr_price']; ?> <input type="radio" name="color" value="<?php echo $attr['attr_value']; ?>" checked="checked" /></a>
										<?php endforeach; ?>
